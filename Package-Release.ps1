...
try {
    ...
    Copy-Item -LiteralPath (Join-Path $PSScriptRoot "docs\DEPENDENCIES_1.0.8.md") -Destination (Join-Path $packageRoot "docs\DEPENDENCIES.md")
    Copy-Item -LiteralPath (Join-Path $PSScriptRoot "docs\SOURCE_OFFER_1.0.8.md") -Destination (Join-Path $packageRoot "docs\SOURCE_OFFER.md")
    Copy-Item -LiteralPath (Join-Path $PSScriptRoot "docs\PAYMENT_SECURITY_1.0.8.md") -Destination (Join-Path $packageRoot "docs\PAYMENT_SECURITY.md")
