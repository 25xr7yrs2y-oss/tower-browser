# Hosted payment security and provenance (1.0.10)

## Unchanged payment authority and architecture

Version 1.0.10 normalizes product branding and release automation and does not
change the 1.0.8 payment implementation. The application remains a native client of its
...
for 1.0.10. Automated build/tests do not establish production payment success.
