# Version 1.0.8 bundled dependencies

The portable package is assembled without running either upstream installer.
The 1.0.8 controller-side Stripe/PayPal hosted-checkout and lifecycle update
reuses the exact pinned and verified backend binary shipped by 1.0.6. No
Stripe or PayPal merchant SDK/library is added; the existing Myst node and
Mysterium Pilvytis service remain the order and wallet-credit authority.
